...
app = Flask(__name__)
CORS(app)
print("--> Starting DALL-E Server. This might take up to ten minutes.")
...
parser.add_argument("--img_format", type = str.lower, default = "PNG", help = "Generated images format", choices=['jpeg', 'png'])
